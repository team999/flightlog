(function($) {
    ...
    $.fn.extend({
        ...
        removeCircles: function() {
            return this.each(removeObjects('circles'));
        },
        ...
        addCircles: function(obj) {
            return this.each(addObjects('circles', obj));
        },
        ...
        fitCircles: function(zoom) {
            return this.each(fitObjects('circles', zoom));
        },
